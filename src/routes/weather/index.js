...
export default function Home(props) {
    ...
    const fetchData = async () => {
        const url = `https://api.openweathermap.org/data/2.5/forecast/daily?lat=${searchParams.get('lat')}&lon=${searchParams.get('long')}&cnt=16&appid=${process.env.APP_ID}&units=imperial`;
        try {
